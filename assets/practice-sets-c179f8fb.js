import { g as defineComponent, k as useDisplay, j as inject, i as ref, z as computed, p as onMounted, r as resolveComponent, o as openBlock, c as createElementBlock, a as createVNode, b as createBaseVNode, F as Fragment, h as renderList, u as unref, s as storageKey, e as createBlock, w as withCtx, m as mergeProps, d as createTextVNode, t as toDisplayString, O as normalizeStyle } from "./index-63eb1cfb.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const itemStyle = computed(
      () => `max-width: ${mdAndDown.value ? "100%; width: 100% !important" : "calc(100% / 3 - 6px)"};`
    );
    onMounted(async () => {
